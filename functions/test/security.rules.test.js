...
test('dream journal access allows owner and admin, rejects other users', async () => {
...
test('marketplace rules require pending review on create and allow admin moderation', async () => {
...
test('storage rules allow owners and admins but block other users', async () => {
