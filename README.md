...
4. Seed Firestore with starter data:
   ...
   ```
   The script populates the crystal library, feature flags, demo user, moon ritual preferences, and a pending marketplace listing.【F:scripts/seed_database.js†L1-L360】
