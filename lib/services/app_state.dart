...
class AppState extends ChangeNotifier {
  ...
  Future<void> _loadCrystalCollection() async {
    ...
    try {
      ...
      final crystals = await Future.wait(snapshot.docs.map((doc) async {
        ...
        return crystal.copyWith(
          id: crystal.id.isNotEmpty ? crystal.id : doc.id,
  ...
  Future<Crystal> _fetchCrystalFromLibrary(String libraryRef) async {
    ...
    if (key.isNotEmpty && _crystalLibraryCache.containsKey(key)) {
