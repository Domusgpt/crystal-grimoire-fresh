...
class AuthService extends ChangeNotifier {
  ...
  static Future<void> deleteAccount() async {
    ...
    try {
      ...
      try {
        ...
        // Ignore Google sign-out errors once the Firebase session is cleared
      }
  ...
  static Future<void> _createUserDocument(User user) async {
    ...
    final profile = <String, dynamic>{
      ...
      'photoUrl': user.photoURL ?? existingProfile['photo'] ?? existingProfile['photoUrl'],
      'subscriptionTier': (existingProfile['subscriptionTier'] ?? 'free').toString(),
      'subscriptionStatus': existingProfile['subscriptionStatus'] ?? 'active',
      'stats': existingProfile['stats'] is Map<String, dynamic>
      ...
      'consent': existingProfile['consent'] is Map<String, dynamic>
    ...
    profile['createdAt'] = existingProfile['createdAt'] ?? FieldValue.serverTimestamp();
