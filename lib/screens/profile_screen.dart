...
class _AccountScreenState extends State<AccountScreen>
  ...
  String get _userName =>
      _profileData?['displayName']?.toString() ?? _currentUser?.displayName ?? 'Crystal Seeker';
  String get _userEmail => _currentUser?.email ?? 'No email';
  String get _memberSince {
    final createdAt = _coerceToDateTime(_profileData?['createdAt']) ??
        _coerceToDateTime(_userData?['createdAt']);
  ...
  String get _currentTier =>
      (_planData?['plan'] ?? _profileData?['subscriptionTier'] ?? 'free').toString();
    ...
    try {
      ...
      if (_currentUser != null) {
        ...
        if (userDoc.exists) {
          ...
          _profileData = _userData?['profile'] is Map<String, dynamic>
              ? Map<String, dynamic>.from(_userData!['profile'] as Map)
              : <String, dynamic>{};
          _planWillRenew = _profileData?['subscriptionWillRenew'] == true;
          _planExpiresAt = _coerceToDateTime(_profileData?['subscriptionExpiresAt']);
        }
  ...
  Future<void> _loadPlanAndUsage(String uid) async {
    try {
      ...
      final profileLimits = _profileData?['effectiveLimits'];
      final limits = planLimitsRaw is Map<String, dynamic>
          ? Map<String, dynamic>.from(planLimitsRaw)
          : profileLimits is Map<String, dynamic>
              ? Map<String, dynamic>.from(profileLimits)
              : <String, dynamic>{};
